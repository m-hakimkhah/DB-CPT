...
if __name__ == '__main__':
    ...
    parser.add_argument('--mix_file_path', type=str, default='/content/drive/MyDrive/NetworkHakim2_16k/noisy_testset_wav')
    parser.add_argument('--esti_file_path', type=str, default='/content/drive/MyDrive/5est_DBCPT')
    parser.add_argument('--snr', type=list, default=[-5, 0, 5, 10, 15, 20])     #  -5  -2  0  2  5
    parser.add_argument('--fs', type=int, default=16000,
                        help='The sampling rate of speech')
    parser.add_argument('--Model_path', type=str, default='/content/drive/MyDrive/DB_CPT/BEST_MODEL/XXX0.pth.tar',
